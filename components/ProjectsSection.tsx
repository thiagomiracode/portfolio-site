...
const translations = {
  pt: {
    ...
    subtitle: "Soluções que unem inteligência artificial e alta performance.",
    ...
    projects: [
      ...
      },
      {
        ...
        description:
          "Análise preditiva de faturamento e comportamento de estoque usando Machine Learning e SQL.",
      },
      {
        title: "SmartBot SaaS",
        description:
  ...
  en: {
    ...
    subtitle:
      "Solutions that combine artificial intelligence and high performance.",
    ...
    projects: [
      ...
      },
      {
        title: "Predictive Dashboard",
        description:
          "Predictive analysis of revenue and inventory behavior using Machine Learning and SQL.",
      },
      {
        title: "SmartBot SaaS",
        description:
...
export default function ProjectsSection() {
  ...
  const baseProjects = [
    {
      image: "/DocIntelligenceAI.png",
      tags: ["AI", "Laravel", "Python"],
      link: "#",
    },
    {
      image: "/PredictiveDashboard.png",
      tags: ["React", "MySQL", "ML"],
      link: "#",
    },
    {
      image: "/SmartBotSaas.png",
  ...
  return (
    <section className="py-24 bg-[#0f172a]" id="projetos">
